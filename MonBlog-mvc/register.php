...
<body>
    ...
    <body class="align">
        ...
        <div class="grid">
            ...
            <form action="index.php?action=register" method="POST" class="form login">

                <div class="form__field">
                    <label for="login__email"><svg class="icon">
                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use>
                        </svg><span class="hidden">Email d'utilisateur</span></label>
            ...
            <p class="text--center">Déjà signé<a href="login.php">Se connecter</a> <svg class="icon">
